...
const socials = {
  x: "https://x.com/alsaif_legal",
  snapchat: "https://snapchat.com/t/08yV1FOk",
  email: "info@alsaiflegal.com",
  // website: "https://alsaiflegal.com/",
};
...
export default function Links() {
  return (
    <div className="flex flex-col justify-center items-center h-screen p-4">
      {/* Logo */}
      <Image src="/logo.jpg" width={100} height={100} alt="alsaiflegal logo" />

      {/* Socials */}
      <div className="flex justify-around items-center w-[40%] mt-[4rem]">
        <svg
