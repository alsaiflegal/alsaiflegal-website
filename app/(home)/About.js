...
export default function About() {
  return (
    <section className="py-32 px-4 bg-gradient-to-b from-offwhite via-ivory to-offwhite relative overflow-hidden" dir="rtl" id="about">
      {/* Decorative Background Elements */}
      <div className="absolute top-20 right-10 w-72 h-72 bg-gold/5 rounded-full blur-3xl"></div>
      <div className="absolute bottom-20 left-10 w-96 h-96 bg-navy/5 rounded-full blur-3xl"></div>
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-radial from-gold/[0.02] to-transparent rounded-full"></div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="group relative bg-white rounded-3xl p-8 md:p-10 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 hover:rotate-[0.5deg] border border-gray-100 hover:border-gold/50 flex flex-col items-center text-center animate-[fadeInUp_1s_ease-out_0.2s_forwards] opacity-0 overflow-hidden">
            ...
            <div className="relative z-10 w-20 h-20 rounded-full bg-gold/10 flex items-center justify-center mb-6 group-hover:bg-gold group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-gold/30 transition-all duration-500">
            ...
            <h3 className="text-2xl font-bold text-navy mb-4 group-hover:text-gold transition-colors duration-300">بماذا نتميز</h3>
            <p className="text-navy/70 leading-relaxed">
              نتميز بخبرة نظامية واسعة وفريق محترف يضم محامين محليين ودوليين يمتلكون معرفة عميقة بالأنظمة المحلية والدولية، مما يمنحنا القدرة على تلبية احتياجات عملائنا بكفاءة واحترافية عالية.
            </p>
          </div>
          ...
          <div className="group relative bg-white rounded-3xl p-8 md:p-10 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 hover:rotate-[-0.5deg] border border-gray-100 hover:border-gold/50 flex flex-col items-center text-center animate-[fadeInUp_1s_ease-out_0.4s_forwards] opacity-0 overflow-hidden">
            ...
            <h3 className="relative z-10 text-2xl font-bold text-navy mb-4 group-hover:text-gold transition-colors duration-300">أسلوب عملنا</h3>
            <p className="relative z-10 text-navy/80 leading-relaxed">
              نركز على بناء شراكات استراتيجية طويلة الأمد مع عملائنا، ونحول احتياجاتهم إلى حلول نظامية دقيقة وفعّالة. نضمن الشفافية الكاملة، وسلاسة سير العمل، والاعتماد على أفضل الممارسات النظامية المعترف بها دولياً.
            </p>
          </div>
          ...
          <div className="group relative bg-white rounded-3xl p-8 md:p-10 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 hover:rotate-[0.5deg] border border-gray-100 hover:border-gold/50 flex flex-col items-center text-center animate-[fadeInUp_1s_ease-out_0.6s_forwards] opacity-0 md:col-span-2 lg:col-span-1 overflow-hidden">
            ...
            <h3 className="relative z-10 text-2xl font-bold text-navy mb-4 group-hover:text-gold transition-colors duration-300">قيمنا</h3>
            <p className="relative z-10 text-navy/80 leading-relaxed">
