        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-10">
          ...
          <div className="flex-shrink-0">
            <Image
              ...
              height={100}
              alt="Alsaif Legal"
              className="w-64 h-auto opacity-90 hover:opacity-100 transition-opacity duration-300"
            />
          </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center gap-3 group">
                ...
                <div className="flex flex-col">
                  ...
                  <a href="tel:+966530733805" className="text-gray-300 hover:text-white transition-colors duration-300 text-lg" dir="ltr">
                    +966 53 073 3805
                  </a>
                </div>
              </div>
          ...
          <div className="flex gap-4">
            {[
              ...
              <a
                ...
                className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center hover:bg-gold hover:-translate-y-1 transition-all duration-300 group"
