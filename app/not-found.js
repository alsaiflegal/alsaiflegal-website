...
export default function NotFound() {
  return (
    <div
      className="min-h-screen bg-gradient-to-b from-navy via-navy-light to-navy flex items-center justify-center px-4 relative overflow-hidden"
      dir="rtl"
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute bottom-20 left-20 w-96 h-96 bg-gold/5 rounded-full blur-3xl animate-pulse"
      ...
      <div
        className="absolute bottom-10 right-10 w-2 h-2 bg-gold rounded-full animate-ping"
        style={{ animationDelay: "0.5s" }}
      ></div>
      <div className="absolute top-1/3 right-1/4 w-1 h-1 bg-gold/50 rounded-full animate-pulse"></div>
      <div
        className="absolute bottom-1/3 left-1/4 w-1 h-1 bg-gold/50 rounded-full animate-pulse"
        style={{ animationDelay: "1s" }}
      ></div>
    </div>
  );
